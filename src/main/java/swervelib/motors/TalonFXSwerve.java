...
public class TalonFXSwerve extends SwerveMotor {
    ...
    public void configureIntegratedEncoder(double positionConversionFactor) {
        ...
        configuration.MotionMagic = configuration.MotionMagic.withMotionMagicCruiseVelocity(
        ...
        configuration.Feedback.withFeedbackSensorSource(
    ...
    public void setCurrentLimit(int currentLimit) {
        ...
        cfg.apply(
            configuration.CurrentLimits.withSupplyCurrentLimit(
                currentLimit
