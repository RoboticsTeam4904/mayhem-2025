...
public class ModuleJson {
    ...
    public SwerveModuleConfiguration createModuleConfiguration(
        ...
        if (this.conversionFactor == null && physicalCharacteristics.conversionFactor == null) {
            ...
            physicalCharacteristics.conversionFactor != null && this.conversionFactor == null
        ) {
            this.conversionFactor = physicalCharacteristics.conversionFactor;
        } else if (physicalCharacteristics.conversionFactor != null) { // If both are defined, override 0 with the physical characterstics input.
            this.conversionFactor.angle = this.conversionFactor.angle == 0
                ? physicalCharacteristics.conversionFactor.angle
                : this.conversionFactor.angle;
            this.conversionFactor.drive = this.conversionFactor.drive == 0
