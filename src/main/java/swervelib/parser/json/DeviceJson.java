...
public class DeviceJson {
     ...
     */
    private final Alert canIdWarning = new Alert(
        "JSON",
     ...
     */
    private final Alert i2cLockupWarning = new Alert(
        "IMU",
     ...
     */
    private final Alert serialCommsIssueWarning = new Alert(
        "IMU",
                    ...
                    default:
                        if (isDriveMotor) {
                            throw new RuntimeException(
                                "Spark MAX " +
                                id +
                                " MUST have a encoder attached to the motor controller."
                            );
                        }
