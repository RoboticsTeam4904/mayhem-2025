...
public class SwerveDriveTelemetry {
     ...
     */
    public static final Alert canIdWarning = new Alert(
        "JSON",
     ...
     */
    public static final Alert i2cLockupWarning = new Alert(
        "IMU",
     ...
     */
    public static final Alert serialCommsIssueWarning = new Alert(
        "IMU",
     ...
     */
    private static final DoublePublisher moduleCountPublisher = NetworkTableInstance.getDefault()
     ...
     */
    private static final DoublePublisher robotRotationPublisher = NetworkTableInstance.getDefault()
        .getTable("SmartDashboard")
     ...
     */
    private static final DoublePublisher odomCycleTime = NetworkTableInstance.getDefault()
        .getTable("SmartDashboard")
     ...
     */
    private static final DoublePublisher ctrlCycleTime = NetworkTableInstance.getDefault()
        .getTable("SmartDashboard")
