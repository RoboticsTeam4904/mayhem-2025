...
public class SwerveDrive {
    ...
    public void drive(
        ...
        if (headingCorrection) {
            if (
                Math.abs(velocity.omegaRadiansPerSecond) < HEADING_CORRECTION_DEADBAND &&
        ...
        if (SwerveDriveTelemetry.verbosity.ordinal() >= TelemetryVerbosity.HIGH.ordinal()) {
            ...
            SwerveDriveTelemetry.desiredChassisSpeeds[2] = Math.toDegrees(
    ...
    public void setModuleStates(SwerveModuleState[] desiredStates, boolean isOpenLoop) {
        setRawModuleStates(
            kinematics.toSwerveModuleStates(kinematics.toChassisSpeeds(desiredStates)),
            isOpenLoop
        );
    }
    ...
    public void setMaximumSpeed(
        ...
        for (SwerveModule module : swerveModules) {
            ...
            if (updateModuleFeedforward) {
                module.feedforward = SwerveMath.createDriveFeedforward(
                    optimalVoltage,
                    maximumSpeed,
    ...
    public void setMaximumSpeed(double maximumSpeed) {
        setMaximumSpeed(
            maximumSpeed,
            true,
            swerveDriveConfiguration.physicalCharacteristics.optimalVoltage
        );
    }
    ...
    public void updateOdometry() {
        ...
        try {
            ...
            if (SwerveDriveTelemetry.verbosity.ordinal() >= TelemetryVerbosity.HIGH.ordinal()) {
                Pose2d[] modulePoses = getSwerveModulePoses(
                ...
                SwerveDriveTelemetry.measuredChassisSpeeds[1] =
                    measuredChassisSpeeds.vyMetersPerSecond;
                SwerveDriveTelemetry.measuredChassisSpeeds[0] =
                    measuredChassisSpeeds.vxMetersPerSecond;
                SwerveDriveTelemetry.measuredChassisSpeeds[2] = Math.toDegrees(
