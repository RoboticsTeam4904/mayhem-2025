...
public class SwerveController {
    ...
    public double getJoystickAngle(double headingX, double headingY) {
        lastAngleScalar = withinHypotDeadband(headingX, headingY)
            ? lastAngleScalar
    ...
    public ChassisSpeeds getTargetSpeeds(
        ...
        double angle = withinHypotDeadband(headingX, headingY)
            ? lastAngleScalar
            : Math.atan2(headingX, headingY);
        ChassisSpeeds speeds = getTargetSpeeds(
            xInput,
            yInput,
            angle,
            currentHeadingAngleRadians,
            maxSpeed
        );
