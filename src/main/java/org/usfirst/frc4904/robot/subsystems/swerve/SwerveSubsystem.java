...
public class SwerveSubsystem extends SubsystemBase {
    ...
    public Command c_input(double x, double y, double theta) {
        ...
        return c_drive(translation, theta * SwerveConstants.ROT_SPEED);
    }
    ...
    public Translation2d robotRelative(Translation2d translation) {
        ...
        return translation.rotateBy(Rotation2d.fromDegrees(-rotation)); // TODO MAYBE WRONG
    }
    ...
    public Command c_drive(Translation2d translation, double theta) {
        ...
        Command cmd = new ParallelCommandGroup(commands);
        cmd.addRequirements(Component.chassis);
        return cmd;
    }
}
